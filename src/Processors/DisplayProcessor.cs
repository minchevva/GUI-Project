...
namespace Draw
{
	...
	public class DisplayProcessor
	{
		...
		/// </summary>
		private List<ShapeM> shapeMList = new List<ShapeM>();		
		public List<ShapeM> ShapeMList {
			get { return shapeMList; }
			set { shapeMList = value; }
		}
		...
		{
			foreach (ShapeM item in ShapeMList){
				DrawShape(grfx, item);
			}
		}
		...
		public virtual void DrawShape(Graphics grfx, ShapeM item)
		{
			item.DrawSelf(grfx);
		}
