...
{
	[Serializable]
	public class PolygonShapeM : ShapeM
	{
		...
		public PolygonShapeM(PointF one, PointF two, PointF three, PointF four, PointF five, PointF six) 
		{
			One = one;
			Two = two;
			Three = three;
		...
		public PolygonShapeM(PolygonShapeM polygon) : base(polygon)
		{
