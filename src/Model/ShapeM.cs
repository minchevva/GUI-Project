...
namespace Draw
{
	...
	public abstract class ShapeM
	{
		...
		public ShapeM(RectangleF rect)
		{
			rectangle = rect;
		}
		
		public ShapeM(ShapeM shape)
		{
		...
		public virtual void MoveGroupedShapeM(float dx, float dy)
		{
		...
		public virtual void ChangeGroupStrokeWidth(float borderWidthShapeM)
		{
			borderWidth = borderWidthShapeM;
		}
		...
		public virtual void RotateShapeM(Graphics grfx)
		{
